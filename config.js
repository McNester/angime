...
const CONFIG = {
    // URL меню в облаке (JSONBin)
    REMOTE_MENU_URL: 'https://api.jsonbin.io/v3/b/69b6b143c3097a1dd528decd/latest',
...
const TRANSLATIONS = {
    ru: {
        ...
        reason1Desc: '12 сортов отечественного производства. От легких лагерей до насыщенных элей.',
